...
const settingPage = ['profile', 'logout'];
        ...
        <AppBar position="static">
            <Container maxWidth="xl">
                <Toolbar disableGutters>
                    ...
                    <FacebookIcon sx={{ display: { xs: 'flex', md: 'none' }, mr: 1 }} />
                    <Typography
                        variant="h5"
                        noWrap
                        component="a"
                        ...
                        <Tooltip title="Open settings">
                            <IconButton onClick={handleOpenUserMenu} sx={{ p: 0 }}>
                                {getProfile.pictureUrl === "" ?
                                    ...
                                    <Avatar alt="Remy Sharp" src={getProfile.pictureUrl} />
                                }
                            </IconButton>
                        </Tooltip>
                        <Menu
                        ...
                        >
                            {settings.map((setting, index) => (
                                <MenuItem key={setting} onClick={handleCloseUserMenu}>
                                    <Typography textAlign="center" onClick={() => router.push(`/${settingPage[index]}`)}>{setting}</Typography>
                                </MenuItem>
                            ))}
                        </Menu>
                    </Box>
